...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddList = __webpack_require__(2);
	...
	var App = React.createClass({displayName: "App",
		...
		render: function() {
			var componentList = this.state.lists.map(function(item, index){
	      		return React.createElement(ListContainer, {title: item.newTitle, key: item.index, index: index, remove: this.handleRemoveList, bg: item.bgColor})
	    	}.bind(this));
	    	return (
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var ColorList = __webpack_require__(152);
	...
	var AddList = React.createClass ({displayName: "AddList",
		...
		return (
	      	React.createElement("form", {className: "col-sm-6", onSubmit: this.handleSubmit}, 
		        ...
		        "List Name:", 
		        React.createElement("input", {type: "text", placeholder: "List Name", className: "form-control", value: this.state.listName, onChange: this.handleChange}), " ", React.createElement("br", null), 
		        "List Background Color: ", React.createElement("span", {style: styles.colorIndicator}), 
		        React.createElement(ColorList, {chooseColor: this.chooseBackground}), " ", React.createElement("br", null), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorList = React.createClass({displayName: "ColorList",
	  render: function(){
	    var styles = {
	      colorBG: {
	        width: "20%",
